...
function init() {
  ...
  initFormHandler();
  // Add event listener to the "Add New Recipe" button
...
function getRecipesFromStorage() {
  ...
  // Parse the recipes string back into an array of objects
...
/**
 * Shows the hidden form by removing the "hidden" class
 */
function showForm() {
